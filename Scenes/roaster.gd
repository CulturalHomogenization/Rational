...
@export var station_name: String = "Roasting Station"
...
@export var recipes: Array[Dictionary] = [
	{
		"ingredients": ["chopped_meat"],
		"result": "Cooked meat"
	},
	{
		"ingredients": ["chopped_carrot", "chopped_potato"],
		"result": "Vegetable Jerky Mix"
	},
	{
		"ingredients": ["chopped_fish"],
		"result": "Cooked fish"
	},
	{
		"ingredients": ["noodles"],
		"result": "Dried Noodle Block"
	}
]
