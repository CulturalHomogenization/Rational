...
@export var station_name: String = "Stove"
...
@export var recipes: Array[Dictionary] = [
	{
		"ingredients": ["chopped_potato", "chopped_carrot"],
		"result": "Steamed Veg Pouch"
	},
	{
		"ingredients": ["chopped_potato", "chopped_onion"],
		"result": "Stew Pack"
	},
	{
		"ingredients": ["cooked_fish", "chopped_onion", "spices"],
		"result": "Fish Stew Can"
	},
	{
		"ingredients": ["cooked_meat", "chopped_potato", "spices"],
		"result": "Luxury Survival Stew"
	}
]
